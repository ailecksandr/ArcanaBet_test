...
SimpleForm.setup do |config|
  ...
  config.wrappers :default, class: :input,
    hint_class: :field_with_hint, error_class: :field_with_errors do |builder|
    ...
    ## Inputs
    builder.use :label
    builder.use :hint, wrap_with: { tag: :span, class: :hint }
    builder.use :input
    builder.use :error, wrap_with: { tag: :span, class: :error }
